...
begin
  ...
  FGameText := Factory.NewText();

  with FAboutText do
  begin
    Font := fontSouvenir;
    Text := 'для четвертой областной'#13#10'IT-олимпиады GoodLine'#13#10#13#10'— perfect.daemon —'#13#10'   ноябрь 2013';
  ...
  begin
    Font := fontSouvenir;
    Text := 'Описание игры на олимпиаду'
        +#13#10'продолжается здесь';
  ...
  FScene.RootNode.AddChild(FGameText);
end;
  ...
  case aStatus of
    ...
    begin
      ...
      Tweener.AddTweenPSingle(@FAboutText.PPosition.y, tsExpoEaseIn,
        R.WindowHeight + 120, R.WindowHeight + ABOUT_OFFSET_Y, TIME_ABOUTTEXT, TIME_ABOUTTEXT_PAUSE + 0.2);

      Tweener.AddTweenPSingle(@FGameText.PPosition.Y, tsExpoEaseIn,
        -150, GAMETEXT_OFFSET_Y, TIME_ABOUTTEXT + 1, TIME_ABOUTTEXT_PAUSE);
    end;
