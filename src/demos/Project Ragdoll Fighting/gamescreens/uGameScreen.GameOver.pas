...
begin
  ...
  begin
    if player.IsDead and player2.IsDead then
      FGameOverText.Text := 'Невероятно! Сообщите об этом разработчику!'
    else if player.IsDead then
      FGameOverText.Text := 'Увы, вас разнесло на куски...'#13#10'Попробуйте снова или измените сложность в меню опций'
    else if player2.IsDead then
      FGameOverText.Text := 'Вы не оставили на противнике живого места!'#13#10'Повторите или повысьте сложность в меню опций'
  end
  else
  begin
    if player.IsDead and player2.IsDead then
      ...
      FGameOverText.Text := 'Увы, игрока 1 разнесло на куски...'#13#10'Игрок 2 победил!'
    else if player2.IsDead then
      FGameOverText.Text := 'Увы, игрока 2 разнесло на куски...'#13#10'Игрок 1 победил!'
  end;
end;
