...
//  glrCreateNode: function(aParent: IglrNode): IglrNode; stdcall;
//  glrCreateUserRender: function(): IglrUserRenderable; stdcall;
//  glrCreateHUDSprite: function(): IglrSprite; stdcall;
//  glrCreateMaterial: function(): IglrMaterial; stdcall;
//  glrCreateTexture: function(): IglrTexture; stdcall;
//  dfCreateFont: function(): IglrFont; stdcall;
//  dfCreateText: function(): IglrText; stdcall;
//  dfCreateGUIButton: function(): IglrGUIButton; stdcall;
//  dfCreateGUITextButton: function(): IglrGUITextButton; stdcall;
//  dfCreateGUICheckBox: function(): IglrGUICheckBox; stdcall;
//  dfCreateGUITextBox: function(): IglrGUITextBox; stdcall;
//  dfCreateGUISlider: function(): IglrGUISlider; stdcall;
//
//  dfCreate2DScene: function(): Iglr2DScene; stdcall;
...
//  glrCreateNode := GetProcAddress(dllHandle, 'CreateNode');
//  glrCreateUserRender := GetProcAddress(dllHandle, 'CreateUserRender');
//  glrCreateHUDSprite := GetProcAddress(dllHandle, 'CreateHUDSprite');
//  glrCreateMaterial := GetProcAddress(dllHandle, 'CreateMaterial');
//  glrCreateTexture := GetProcAddress(dllHandle, 'CreateTexture');
...
//  dfCreateGUITextButton := GetProcAddress(dllHandle, 'CreateGUITextButton');
